...
class UltraFace {
public:
    UltraFace(const std::string& bin_path, const std::string& param_path, int input_size, int num_thread_ = 1, int topk_ = -1, float score_threshold_ = 0.7, float iou_threshold_ = 0.4);
    ~UltraFace();
